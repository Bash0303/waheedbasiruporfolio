...
const Navbar = () => {
  ...
  return (
    <div className={`border-2 border-b-4 w-full h-20 sticky top-0 z-50 transition-all duration-300 px-4 md:px-7 xl:px-12 2xl:px-80 flex justify-between items-center font-titleFont 
