...
const ResumeCard3 = ({ title, subTitle, result, des }) => {
  return (
    <div className="flex w-full h-auto group relative">
      ...
      <div className="flex flex-col justify-center w-full gap-6 p-6 transition-all duration-300 bg-white rounded-xl shadow-sm border border-slate-100 group-hover:shadow-lg">
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
          <div>
             {/* CHANGE: High visibility text-slate-950 */}
        ...
        <ul className="flex flex-col w-full list-disc gap-y-1 pl-1 marker:text-blue-600">
          <li className="pl-1">
            <p className="text-base font-normal text-justify text-slate-700 leading-relaxed">
              {des}
            </p>
          </li>
        </ul>
